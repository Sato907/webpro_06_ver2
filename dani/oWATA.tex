...
新規登録を行うmanga\_create.htmlにおいては，ユーザが主な思想欄にてどのようなことを入力すべきかを援助するために，placeholderを用いて薄字で「ここに思想の名前を入力」など表示するように設計した．更に，「＋別の思想を追加」ボタンを押下された場合，先に表示されているような思想，説明の枠ど同様のものが表示されるように設計を追加した．<script></script>で囲われている部分が該当箇所である．ブラウザのちょっとした処理であるためこの技術を採用した．
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono2-2.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono3-2.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono41.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono42.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono43-2.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sono44-2.pdf}
    ...
    \begin{subfigure}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sono45-2.pdf}
        \caption{ニーチェシステムの編集をする画面(表)}
        \label{fig:sono45}
    \end{subfigure}
    \caption{ニーチェシステムの編集画面（1/2）}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sono46-2.pdf}
        \caption{ニーチェシステムの編集をする画面(主な思想)}
        \label{fig:sono46}
    \end{subfigure}
    \caption{ニーチェシステムの編集画面（2/2）}
    \label{fig:edit_screens}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sono47-2.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{sonono1-1.pdf}
