...
let nietzsche = [
  { name:"フリードリヒ・ニーチェ", birth:1844, death:1900,intro:"現代の京都に突如として表れた，自称哲学者の美青年．その正体は，19世紀ドイツを代表する哲学者フリードリヒ・ニーチェだった!?かつて「神は死んだ」と宣言しキリスト教的道徳を打ち壊そうとした過激な思想家としての面影を残しつつ，現代の日本のサブカルチャーに異常なまでの適応力をみせる．特にソシャゲを嗜んでおり哲学を説く際においても例として挙げるほどである．主人公のアリサに対し，「末人」に陥るのではなく「超人」を目指せと説き，彼女が抱える悩みや閉塞感を，アクロバティックな論理と情熱的な言葉で解体していく．",
    thoughts: [
    {
      title: "ルサンチマン",
      description: "弱者が強者に対して抱く嫉妬や恨みの感情。自らの無力を正当化するために、相手を『悪』と見なす心理構造のこと。"
    },
    {
      title: "超人",
    ...
    {
      title: "永劫回帰",
      description: "この人生が全く同じ形で何度も繰り返されるという思想。それを絶望ではなく『快楽』として肯定できる生き方を説く。"
    }
  ],book:"『悲劇の誕生』『反時代的考察』『人間的な、あまりに人間的な』『曙光』『悦ばしき知識』『ツァラトゥストラはこう言った』『善悪の彼岸』『道徳の系譜』『ワーグナーの場合』『偶像の黄昏』『アンチクリスト』『ニーチェ対ワーグナー』『この人を見よ』",story:"1,2,"},
